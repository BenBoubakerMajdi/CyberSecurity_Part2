...
.method private static final extractParameterInfo(Ljava/util/List;Landroidx/compose/ui/tooling/data/SourceInformationContext;)Ljava/util/List;
    ...
    invoke-static {v11, v12, v8, v5, v6}, Lkotlin/text/StringsKt;->endsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {v2, v3}, Landroidx/compose/ui/tooling/data/SlotTreeKt;->accessibleField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v2

    .line 800
    .local v2, "blockField":Ljava/lang/reflect/Field;
    if-eqz v2, :cond_15
    ...
    invoke-static {v4, v10}, Landroidx/compose/ui/tooling/data/SlotTreeKt;->accessibleField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .line 848
    .end local v2    # "blockField":Ljava/lang/reflect/Field;
    ...
    .line 807
    .restart local v2    # "blockField":Ljava/lang/reflect/Field;
    ...
    .end local v2    # "blockField":Ljava/lang/reflect/Field;
    .local v24, "blockField":Ljava/lang/reflect/Field;
    const-string v2, "$"
    ...
    .local v25, "blockClass":Ljava/lang/Class;
    .local v27, "$this$filterTo$iv$iv":[Ljava/lang/Object;
    ...
    .end local v24    # "blockField":Ljava/lang/reflect/Field;
    .end local v25    # "blockClass":Ljava/lang/Class;
    .end local v27    # "$this$filterTo$iv$iv":[Ljava/lang/Object;
    .restart local v1    # "recomposeScope":Ljava/lang/Object;
    .restart local v2    # "blockField":Ljava/lang/reflect/Field;
    .restart local v4    # "blockClass":Ljava/lang/Class;
    .restart local v7    # "$this$filterTo$iv$iv":[Ljava/lang/Object;
    :cond_9
    move-object/from16 v23, v1
    ...
    .restart local v24    # "blockField":Ljava/lang/reflect/Field;
    .restart local v25    # "blockClass":Ljava/lang/Class;
    move-object v0, v15
    ...
    invoke-direct {v13, v6, v15, v14, v15}, Landroidx/compose/ui/tooling/data/Parameter;-><init>(ILjava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .local v34, "parametersMetadata":Ljava/util/List;
    ...
    .end local v3    # "block":Ljava/lang/Object;
    .local v35, "block":Ljava/lang/Object;
    ...
    invoke-direct/range {v26 .. v33}, Landroidx/compose/ui/tooling/data/ParameterInformation;-><init>(Ljava/lang/String;Ljava/lang/Object;ZZZLjava/lang/String;Z)V
    ...
    .end local v30    # "static":Z
    .end local v33    # "stable":Z
    .end local v34    # "parametersMetadata":Ljava/util/List;
    .end local v35    # "block":Ljava/lang/Object;
    .local v0, "fields":Ljava/util/List;
    ...
    .restart local v34    # "parametersMetadata":Ljava/util/List;
    .restart local v35    # "block":Ljava/lang/Object;
    :goto_e
